        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
							...
							<%
								...
								<tr>
									<td class="text-center"><%=virtualNum %></td>
										<td class="text-left"><a href="adminNoticeView.jsp?idx=<%=dto.getIdx()%>&tname=<%=tname%>"><%=dto.getTitle() %></a></td>
                    ...
                    <button type="button" class="btn btn-info"  onclick="location.href='../space/sub01_write.jsp?tname=notice';">공지사항 글쓰기</button>
